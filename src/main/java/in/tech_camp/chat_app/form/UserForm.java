...
public class UserForm {
  @NotBlank(message = "Name can't be blank", groups = ValidationOrder.class)
  private String name;

  @NotBlank(message = "Email can't be blank", groups = ValidationOrder.class)
  @Email(message = "Email should be valid", groups = ValidationPriority2.class)
  private String email;

  @NotBlank(message = "Password can't be blank", groups = ValidationOrder.class)
